...
--                           exist
--
-- Disposition: keep.  This is the only gate that pins the implementation's
-- shape, as opposed to its behaviour, and it is the one a restructuring for
-- performance has to answer to.
--
