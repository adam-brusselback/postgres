...
-- site: dropping it leaves the whole file green, while the same defect on the
-- direct-modification path is caught twice over.  Found by removing each
-- quoting call in turn and running every gate, not by reading.
--
