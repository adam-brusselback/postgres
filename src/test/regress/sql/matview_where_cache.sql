...
--
-- Test 7: The predicate itself is part of the cache key
--
...
--
-- No DDL between the two refreshes, for Test 6's reason: any relcache
-- invalidation discards the entry this case exists to reuse, and the plans are
-- then rebuilt correctly by accident.
--
